...
import { Swiper as SwiperType } from 'swiper'; // Импортируем тип Swiper
import { Navigation, Pagination } from 'swiper/modules';
import { Swiper as SwiperComponent, SwiperSlide } from 'swiper/react'; // Импортируем Swiper и SwiperSlide
